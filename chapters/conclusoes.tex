...
O presente trabalho atingiu seu objetivo geral de avaliar comparativamente o desempenho das LLMs, especificamente GPT, Gemini e DeepSeek na resolução de questões objetivas do ENADE aplicadas aos 
...
Em resposta à primeira questão de pesquisa (QP01), sobre quão assertivas podem ser as LLMs na resolução de questões em computação, os resultados demonstraram que os modelos atuais atingiram um 
patamar elevado de competência. Observou-se uma convergência de desempenho, especialmente na temperatura 0,8, onde todos os modelos apresentaram probabilidades de acerto semelhantes e consistentes.
...
Uma limitação transversal identificada nos três modelos foi o baixo desempenho na disciplina de Sistemas Operacionais (acurácia entre 28\% e 57\%). Conclui-se que essa dificuldade advém da 
natureza visual e diagramática de muitas questões dessa área (estados de memória, hardware), que impõem barreiras à interpretação puramente textual das LLMs atuais.
